...
class ParserConfig(Base):
    ...
    excel_auto_mode: Annotated[bool, Field(default=True)]
    excel_form_mode: Annotated[Literal["auto", "disabled", "kv_row"], Field(default="auto")]
    excel_fallback_to_table: Annotated[bool, Field(default=True)]
